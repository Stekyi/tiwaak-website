...
function CpuIcon() {
  return (
    <svg className="w-7 h-7 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8}
        d="M9 3H7a2 2 0 00-2 2v2M9 3h6M9 3v2m6-2h2a2 2 0 012 2v2m0 0h2m-2 0v6m0 0h2m-2 0v2a2 2 0 01-2 2h-2m0 0H9m6 0v2M9 21H7a2 2 0 01-2-2v-2m0 0H3m2 0v-6M3 9H1m2 0V7a2 2 0 012-2h2m0 0V3" />
    </svg>
  )
}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeInSection className="text-center mb-14">
          ...
          <p className="mt-4 text-gray-500 max-w-2xl mx-auto">
            From global trade to AI-powered technology and end-to-end project consultancy —
            three pillars, one seamless partnership.
          </p>
        </FadeInSection>
